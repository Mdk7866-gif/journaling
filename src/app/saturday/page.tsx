...
export default function Saturday() {
  const saturdayTasks = [
    ...
    { time: '10:00 – 1:00', description: 'Next.js from Grok', category: 'Coding' },
    { time: '1:00 – 2:30', description: 'Lunch + power nap', category: 'Meal' },
    { time: '2:30 – 4:30', description: 'Next.js from Grok', category: 'Coding' },
    { time: '5:00 – 6:30', description: 'Exercise + shower + relax', category: 'Exercise' },
    { time: '6:30 – 7:30', description: 'Next.js from Grok', category: 'Coding' },
